...
export default function CRM() {
  ...
  const [dateDraft, setDateDraft] = useState({
    anchorDate: simulationAnchorDate || '2026-09-04',
    startDate: customStartDate || '2026-08-08',
    endDate: customEndDate || '2026-09-04',
            ...
            <div className="crm-grid-2">
              ...
              <div className="crm-card">
                ...
                <div className="crm-quick-pill-row" style={{ marginTop: 8 }}>
                  ...
                  {[
                    { label: 'Sep 4, 2026 (Default)', date: '2026-09-04' },
              ...
              <div className="crm-card">
                ...
                <div className="crm-quick-pill-row" style={{ marginTop: 8 }}>
                  ...
                  {[
                    { label: 'Aug 8 – Sep 4, 2026 (Default)', start: '2026-08-08', end: '2026-09-04' },
