...
export const RAW_VIDEOS = [
  {
    ...
    watchTimeHrs: 53470,
    revenue: 106754,
    revenueFormatted: '₹1,06,754.00',
    watchTimeHrsFormatted: '53.47K hrs',
    subscribersGained: 4435,
    subscribersLost: 0,
    netSubscribers: 4435,
    subscribersNet: 4435,
    viewsFormatted: '249.8K',
    subscribersNetFormatted: '+4.4K',
    subscribersGainedFormatted: '+4.4K',
    realtimeViews48h: 395,
    realtimeViews60m: 24
  },
  {
    id: 'VID002',
 ...
 */
export function generateDailyTimeSeries(daysCount = 365, anchorDate = '2026-09-18', videosList = null, graphConfig = {}) {
